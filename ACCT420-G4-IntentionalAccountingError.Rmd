...
These variables provide an overall idea of the scale of the company. They were included as companies may engage in fraud that will result in their assets being overstated. While the balances of more specific sub-classifications of assets may be more informative (as indicators of specific types of fraud being committed), we still decided to include these variables as it may be difficult for a machine learning algorithm to develop a consistent rule or generalisation based on more specific sub-classifications of assets. This is because companies can manipulate different sub-classifications to engage in fraud; for example, one company may choose to manipulate ppent (Property, Plant and Equipment - Total (Net)) while another may choose to manipulate rect (Receivables Total). We do not know what the companies in the training and test sets chose to manipulate, so overall measures of assets are desirable. A logarithmic transformation was applied as companies may have assets on different orders of magnitude. 

More generally, companies may manipulate assets by recording assets they neither control nor own, or by inflating the fair value of their assets. Fair value inflation may be done by: improper estimation of the amounts of future cash flows, improper estimation of the timing of future cash flows, utilising an improper discount rate, and so on. Companies may also treat reductions in fair value as temporary impairments, when this is not appropriate (Zack, 2009). Alternatively, assets may be written down and when subsequently sold, greater profits/gains may be recorded (Jones, 2011).
...
It is more difficult to commit fraud by manipulating cash balances as auditors can verify cash balances by performing cash counts and bank reconciliations. Nevertheless, unrealistic movements in cash balances may be a symptom of some underlying manipulation (Albrecht, Albrecht, Albrecht, and Zimbelman, 2016). Cash may also be overstated to conceal misappropriation by the company’s employees (Hall, 2018).
...
Companies may overstate their receivables by recording fictitious sales. This is related to the recognition of fictitious revenue as well, since increases in revenue are typically matched by increases in current assets. Moreover, provisions for doubtful debts can also be lowered to make the book value of receivables higher than they should rightfully be while decreasing bad debt expense (Epstein, n.d.). It is much easier to manipulate receivables than cash as it is harder to verify the existence of receivables, whereas cash can simply be counted.
...
Companies may manipulate inventory levels in several ways. One method is to inflate the value of inventory (and decrease cost of goods sold), perhaps by recording non-existent inventory, not writing down damaged inventory, and simply adjusting the value of inventory (Kuepper, 2017). This improves both the income statement and the statement of financial position (Epstein, n.d.). Inventory may also be intentionally understated in order to reduce income tax obligations (Elmaleh, 2018).
...
Companies can potentially commit fraud by treating expenses as prepaid when they should in fact be recognised in the current period. This reduces expenses and leads to inflated net income values (Elmaleh, 2018).
...
Liabilities represent a company’s financial obligations to third parties. Companies have an incentive to understate their liabilities to make their statements of financial position appear healthier, as well as to avoid breaching debt covenants. Notably, the Enron scandal involved the creation of special purpose entities under which the company’s liabilities were parked (William, 2002). Other ways of concealing liabilities include taking loans from related entities and writing off debts as forgiven (A., 2015). Companies may also overstate liabilities if they are practising “cookie jar” accounting, which involves creating reserves during years of good performance; the reserves are subsequently tapped into to inflate performance in bad years. Such liabilities may include things like provisions for restructuring (Adkins, 2017), or unearned income. Through this, companies can smooth out volatility in their financial performance, misleading investors into believing that they are consistently meeting earnings targets.
...
Companies may intentionally understate their accrued expenses by not recording them or only recording them in subsequent periods (A., 2015).
...
Companies may understate accounts payable by recording payables in future periods, or inflating purchase returns and discounts (A.,2015).
...
Companies may treat what should be unearned income as earned income. As a result, a sudden dip in the level of unearned income, or the ratio of unearned income to revenue, may be suspicious. Alternatively, unearned income can be used as a reserve in “cookie jar” accounting, as discussed under Section 2.1.2.
...
Companies may have an incentive to overstate working capital due to debt covenants (Smith, 1993) or simply make their liquidity position appear healthier. This can be done by manipulating various asset and liability accounts.
...
Book equity may be overstated if assets have been overstated or liabilities have been understated. Furthermore, misstatements in net income and other comprehensive income will also affect the book equity. 

The market value of the company and number of common shares outstanding will represent the size of the company. According to Juahir, Norsiah, and Norman (2010), the bigger the size of the company, the more likely that the level of internal control will be higher. This could suggest that larger companies are less likely to have fraudulent misstatements.

However, directors and managers from larger companies, especially publicly listed ones, face greater scrutiny and expectations from shareholders. This puts a greater amount of pressure on them and hence creates greater motivations to manipulate financial statements. The Enron case is a good example of how good performance resulted in shareholders expecting even greater performance, leading to financial statement manipulation to hide signs of underperformance (F., 2013). 
...
Companies have a strong incentive to overstate revenue to improve their apparent financial performance. Revenue can be overstated via several methods: fictitious sales from fictitious customers, fictitious sales from real customers (sometimes companies reverse this in the next period to hide fraud), modification of invoices for actual sales, recording revenue in the wrong period, recording revenue as earned instead of unearned (i.e. goods/services have not been provided to the customer), variable selling prices (A., 2004), channel stuffing (sell retailers more products than they are expected to sell (Investopedia, 2018) and round-tripping (which involves making a “sale” to another party, often a related entity, then buying back the item “sold”) (Adkins, 2017). 
...
Expenses may be understated in order to fraudulently inflate profit levels. One method would be capitalising expenses improperly (Jones, 2011), as exemplified by the WorldCom scandal. The following categories of expenses are more likely to be improperly capitalised: start-up costs, research and development costs, repairs and maintenance (recorded under property, plant and equipment), software development and acquisition, websites, development of intangible assets, advertising, and other deferrals and prepaid expenses. Alternatively, expenses may be deferred to later periods (Zack, 2018). Another measure, which may be used in poorly performing years, is known as a “big bath” strategy and may involve, among other methods, recording write-offs, which are subsequently reversed to inflate profits (Investopedia, 2018).
...
Amortization and depreciation may be manipulated by adjusting (typically, extending) the useful lives of assets, resulting in a reduction in expense (Jones, 2011). 
...
| Variable Name | Accounting Name                                                    |
+:=============:+:==================================================================:+
| bkvlps        | Cash Dividends (Cash Flow)                                         |
+---------------+--------------------------------------------------------------------+
...
Year-on-year percentage growth rates were calculated for the following variables, given their likelihood of being manipulated, whether directly or indirectly: am  (Amortization of Intangibles), dp (Depreciation and Amortization), invt (Inventories - Total), gp (Gross Profit (Loss)), recd (Receivables - Estimated Doubtful), rect (Receivables Total), revt  (Revenue - Total) and ni/at (Return on Assets). These growth rates will enable any suspicious fluctuations in the values of these variables to be identified.
...
#### Provision for Doubtful Debts to Revenue

+-----------------------------------------+-------------+----------------------+
| Ratio Name                              | Ratio Code  | Formula              |
+:=======================================:+:===========:+:====================:+
| Provision for Doubtful Debts to Revenue | r_recd_revt | $$recd/revt$$        |
+-----------------------------------------+-------------+----------------------+

As discussed above under 2.1.1.3, provision for doubtful debts can be manipulated to manipulate both the book value of receivables and the bad debt expense. An unusually low value for this ratio may indicate that such manipulation is occurring.
